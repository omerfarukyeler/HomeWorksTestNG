...
public class HomeWorks4  extends TestBase {
    ...
    public void test4 () throws InterruptedException {
        ...
        WebElement howerover =Driver.getDriver().findElement(By.id("nav-link-accountList-nav-line-1"));
        actions.moveToElement(howerover).perform();
        Thread.sleep(3000);

        WebElement findagift =Driver.getDriver().findElement(By.xpath("//span[@class='nav-text']"));
        findagift.click();
        Thread.sleep(2000);

        WebElement giftsforeveryone =Driver.getDriver().findElement(By.xpath("(//h2[@class='ktemvl-1 hSsmQw'])[2]"));
        ...
        Assert.assertTrue(firstpricepage.contains("2.12"));
        Driver.wait(2);
